...
{  
    ...
    public class AccountController : BaseController
    {
        ...
        [AllowAnonymous]
        public ActionResult ExternalLoginCallback(string returnUrl, RegisterExternalLoginModel RegisterExternalLoginModel)
        {
            ...
            else
            {
                ...
                RegisterExternalLoginModel.ProviderDisplayName = OAuthWebSecurity.GetOAuthClientData(result.Provider).DisplayName;
                RegisterExternalLoginModel.ReturnUrl = returnUrl;
